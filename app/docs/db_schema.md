...
| `ref_user_id` | id of the user who created the task | VARCHAR | True | None | False |
| `ref_request_id` | id of the request associated with the task | VARCHAR | True | None | False |
