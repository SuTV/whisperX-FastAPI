...
def to_domain(orm_task: ORMTask) -> DomainTask:
    ...
    return DomainTask(
        ...
        ref_user_id=orm_task.ref_user_id,
        ref_request_id=orm_task.ref_request_id,
        result=orm_task.result,
        file_name=orm_task.file_name,
        temp_file_name=orm_task.temp_file_name,
        transcript_temp_file_name=orm_task.transcript_temp_file_name,
        diarization_temp_file_name=orm_task.diarization_temp_file_name,
        url=orm_task.url,
...
def to_orm(domain_task: DomainTask) -> ORMTask:
    ...
    orm_task = ORMTask(
        ...
        ref_user_id=domain_task.ref_user_id,
        ref_request_id=domain_task.ref_request_id,
        result=domain_task.result,
        file_name=domain_task.file_name,
        temp_file_name=domain_task.temp_file_name,
        transcript_temp_file_name=domain_task.transcript_temp_file_name,
        diarization_temp_file_name=domain_task.diarization_temp_file_name,
        url=domain_task.url,
